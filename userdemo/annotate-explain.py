...
ax.add_artist(el)
ax.annotate(
    "", xy=(x1, y1), xycoords="data", xytext=(x2, y2), textcoords="data",
    arrowprops=dict(
        arrowstyle="-", color="0.5", patchB=None, shrinkB=0,
...
ax.annotate(
    "", xy=(x1, y1), xycoords="data", xytext=(x2, y2), textcoords="data",
    arrowprops=dict(
        arrowstyle="-", color="0.5", patchB=el, shrinkB=0,
        connectionstyle="arc3,rad=0.3",
    ),
)
...
ax.annotate(
    "", xy=(x1, y1), xycoords="data", xytext=(x2, y2), textcoords="data",
    arrowprops=dict(
        arrowstyle="-", color="0.5", patchB=el, shrinkB=5,
        connectionstyle="arc3,rad=0.3",
    ),
)
...
ax.annotate(
    "", xy=(x1, y1), xycoords="data", xytext=(x2, y2), textcoords="data",
    arrowprops=dict(
        arrowstyle="fancy", color="0.5", patchB=el,
