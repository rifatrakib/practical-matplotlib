...
class Game:
    def __init__(self, ax):
        ...
        # pads
        pA, = self.ax.barh(
            pad_a_y, 0.2, height=0.3, color="k", alpha=0.5,
            edgecolor="b", lw=2, label="Player B", animated=True,
        )
        pB, = self.ax.barh(
            pad_b_y, 0.2, height=0.3, left=pad_b_x, color="k", alpha=0.5,
            edgecolor="r", lw=2, label="Player A", animated=True,
        )
        ...
        self.i = self.ax.annotate(
            instructions, (.5, 0.5), name="monospace", va="center", ha="center",
            multialignment="left", xycoords="axes fraction", animated=False,
        )
        ...
        if self.on:
            ...
            for puck in self.pucks:
                if puck.update(self.pads):
                    ...
                    self.ax.legend(
                        loc="center", framealpha=.2, facecolor="0.5",
